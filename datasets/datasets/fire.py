...
class Fire_Dataset(data.Dataset):
    def __init__(self, opt, split):
        ...
        self.opt = opt
        if self.split == "train":
            self.img_dir = "datasets/data/fire_dataset/images/train"
            self.label_path = "datasets/data/fire_dataset/labels/train"
        if self.split == "val":
            self.img_dir = "datasets/data/fire_dataset/images/valid"
            self.label_path = "datasets/data/fire_dataset/labels/valid"
        # if self.split == "test":
        ...
        for name in self.img_names:
            label_path = os.path.join(self.label_path, name.split(".")[0] + ".txt")
            ...
            with open(label_path, 'r') as file:
                ...
                for line in lines:
                    ...
                    class_id, xc,yc,w,h = list(map(float, line))[:]
